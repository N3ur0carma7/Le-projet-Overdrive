...
SKILLS_DATA = {
    ...
    "production": {
        ...
        "skills": [
            ...
            {
                "id": "centrale_nourriture_upgrade",
                "name": "Boost Centrale",
                "description": "Augmente le boost accorde par la centrale respective de +5%",
                "cost": 1000,
                "prerequisites": ["farm_upgrade"],
                "effect": "unlock_building_upgrade",
                "building_type": Batiment.TYPE_CENTRALE_NOURRITURE,
                "max_level": 2,
                "pos": (0.05, 0.25),
            },
            {
                "id": "centrale_argent_upgrade",
                "name": "Boost Centrale",
                "description": "Augmente le boost accorde par la centrale respective de +5%",
                "cost": 1000,
                "prerequisites": ["mine_upgrade", "building_upgrade_mine_3"],
                "effect": "unlock_building_upgrade",
                "building_type": Batiment.TYPE_CENTRALE_ARGENT,
                "max_level": 2,
                "pos": (0.05, 0.80),
            },
            {
                "id": "centrale_vapeur_upgrade",
                "name": "Boost Centrale",
                "description": "Augmente le boost accorde par la centrale respective de +5%",
                "cost": 1000,
                "prerequisites": ["building_upgrade_gen_3"],
                "effect": "unlock_building_upgrade",
                "building_type": Batiment.TYPE_CENTRALE_VAPEUR,
                "max_level": 2,
                "pos": (0.05, 0.15),
            },
            {
                "id": "stockage_argent_upgrade",
                "name": "Stockage Agrandi",
                "description": "Permet d'ameliorer le stockage d'argent au niveau 2",
                "cost": 500,
                "prerequisites": ["building_upgrade_mine_2"],
                "effect": "unlock_building_upgrade",
                "building_type": Batiment.TYPE_STOCKAGE_ARGENT,
                "max_level": 2,
                "pos": (0.30, 0.80),
            },
{
                "id": "stockage_vapeur_upgrade",
                "name": "Stockage Agrandi",
                "description": "Permet d'ameliorer le stockage de vapeur au niveau 2",
                "cost": 500,
                "prerequisites": ["building_upgrade_gen_2"],
                "effect": "unlock_building_upgrade",
...
{
                "id": "stockage_nourriture_upgrade",
                "name": "Stockage Agrandi",
                "description": "Permet d'ameliorer le stockage de nourriture au niveau 2",
                "cost": 500,
                "prerequisites": ["building_upgrade_farm_2"],
                "effect": "unlock_building_upgrade",
                "building_type": Batiment.TYPE_STOCKAGE_NOURRITURE,
                "max_level": 2,
                "pos": (0.15, 0.35),
            },
        ]
